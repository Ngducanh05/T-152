...
- Location: e2e\auth.spec.ts:691:5
...
```ts
  601 | ) {
  602 |   await page.goto("/login");
  603 | 
  604 |   await page
  605 |     .getByLabel("Email")
  606 |     .fill(account.email);
  607 | 
  608 |   await page
  609 |     .getByLabel("Mật khẩu")
  610 |     .fill(account.password);
  611 | 
  612 |   await page
  613 |     .getByRole(
  614 |       "button",
  ...
  629 | 
  630 | test(
  631 |   "guest cannot access user or admin routes",
  632 |   async ({ page }) => {
  633 |     await page.goto("/");
  634 | 
  635 |     await expect(
